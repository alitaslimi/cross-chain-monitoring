...
c1.image(Image.open('CrossChainMonitoring/images/ethereum-logo.png'))
c2.image(Image.open('CrossChainMonitoring/images/bsc-logo.png'))
c3.image(Image.open('CrossChainMonitoring/images/polygon-logo.png'))
c4.image(Image.open('CrossChainMonitoring/images/solana-logo.png'))
c5.image(Image.open('CrossChainMonitoring/images/avalanche-logo.png'))
c6.image(Image.open('CrossChainMonitoring/images/cosmos-logo.png'))
c7.image(Image.open('CrossChainMonitoring/images/algorand-logo.png'))
c8.image(Image.open('CrossChainMonitoring/images/near-logo.png'))
c9.image(Image.open('CrossChainMonitoring/images/flow-logo.png'))
c10.image(Image.open('CrossChainMonitoring/images/thorchain-logo.png'))
c11.image(Image.open('CrossChainMonitoring/images/osmosis-logo.png'))
c12.image(Image.open('CrossChainMonitoring/images/gnosis-logo.png'))
c13.image(Image.open('CrossChainMonitoring/images/optimism-logo.png'))
c14.image(Image.open('CrossChainMonitoring/images/arbitrum-logo.png'))
c15.image(Image.open('CrossChainMonitoring/images/axelar-logo.png'))
...
st.write(
    ...
    [**GitHub Repository**](https://github.com/alitaslimi/Flipside/tree/main/CrossChainMonitoring).
